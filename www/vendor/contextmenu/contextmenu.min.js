const ContextMenuLib = (() => {
    ...
    const attachListeners = () => {
        document.querySelectorAll(".cm-toggle").forEach(t => {
            ...
            if (o) {
                ...
                t.addEventListener("click", n => {
                    if (t.classList.contains("cm-toggle-click")) {
                        n.preventDefault();
                        n.stopPropagation();
                        e(t, o);
                        i(n, o);
        ...
        document.addEventListener("click", event => {
            if (t && !t.contains(event.target) && !event.target.classList.contains("cm-toggle")) {
                o();
            }
        });
        ...
        document.querySelectorAll(".context-menu-dialog ul li").forEach(e => {
            e.addEventListener("click", event => {
                ...
                if (t) {
                    n(e, t); // Call the associated callback
                    o(); // Close the menu after callback is executed
                }
            });
        });
    };
